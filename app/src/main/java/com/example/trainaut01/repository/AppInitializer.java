...
public class AppInitializer {
    private final ExerciseRepository _exerciseRepository;
    private final DayPlanRepository _dayPlanRepository;

    private final List<Exercise> _exercisesGrossMotor;
    private final List<Exercise> _exercisesFineMotor;
    ...
    public AppInitializer(ExerciseRepository exerciseRepository, DayPlanRepository dayPlanRepository) {
        ...
        this._dayPlanRepository = dayPlanRepository;
        this._exercisesGrossMotor = new ArrayList<>();
        this._exercisesFineMotor = new ArrayList<>();
    }

    public void initializeExercises(OnSuccessListener<Void> onSuccess, OnFailureListener onFailure) {

        _exercisesGrossMotor.add(new Exercise("1", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.BICEPS, "Сгибание рук стоя с гантелями",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Monday/monday1.gif", "", 2, 10, 5, 0, 2));

        _exercisesGrossMotor.add(new Exercise("2", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.BICEPS, "Сгибание рук, сидя с упором в бедро",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Monday/monday2.gif", "", 2, 10, 5, 0, 2));

        _exercisesGrossMotor.add(new Exercise("3", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.BICEPS, "Сгибание рук стоя со штангой",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Monday/monday3.gif", "", 2, 10, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("4", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.BICEPS, "Сгибание рук стоя в стороны с гантелями",
        ...
        _exercisesGrossMotor.add(new Exercise("5", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PECTORAL_MUSCLES, "Жим штанги лёжа",
                "1. Ляг на скамью, держи штангу над собой.\n\n" +
                        "2. Опусти штангу к груди, сгибая локти.\n\n" +
                        "3. Поднимай штангу обратно вверх.",
                "gs://trainaut-database.appspot.com/GrossMotor/Monday/monday5.gif", "", 2, 6, 6, 0, 2));

        _exercisesGrossMotor.add(new Exercise("6", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PECTORAL_MUSCLES, "Развод гантелей на скамье",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Monday/monday6.gif", "", 2, 4, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("7", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PECTORAL_MUSCLES, "Жим гантелей лёжа",
                "1. Ляг на скамью, держи гантели над грудью. \n\n" +
                        "2. Опусти гантели к груди, сгибая локти. \n\n" +
                        "3. Поднимай гантели обратно вверх.",
                "gs://trainaut-database.appspot.com/GrossMotor/Monday/monday7.gif", "", 2, 5, 5, 0, 2));

        _exercisesGrossMotor.add(new Exercise("8", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PECTORAL_MUSCLES, "Отжимания широким хватом",
                "1. Встань в упор лежа, руки шире плеч. \n\n" +
                        "2. Опусти тело вниз, сгибая локти.\n\n" +
                        "3. Поднимай тело обратно вверх.",
                "gs://trainaut-database.appspot.com/GrossMotor/Monday/monday8.gif", "", 2, 4, 6, 0, 2));

        _exercisesGrossMotor.add(new Exercise("9", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.TRICEPS, "Отжимания от лавки на трицепс",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday1.gif", "", 2, 5, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("10", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.TRICEPS, "Французский жим гантелей лёжа",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday2.gif", "", 2, 6, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("11", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.TRICEPS, "Жим гантелей из-за головы сидя",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday3.gif", "", 3, 4, 6, 0, 2));

        _exercisesGrossMotor.add(new Exercise("12", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.TRICEPS, "Жим гантелей с переносом центра тяжести на лавку",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday4.gif", "", 2, 6, 7, 0, 2));


        _exercisesGrossMotor.add(new Exercise("13", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.DELTOID_MUSCLES, "Подъём рук в стороны с гантелями",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday5.gif", "", 3, 6, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("14", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.DELTOID_MUSCLES, "Тяга бутылки 5 литров за ручку к подбородку",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday6.gif", "", 2, 5, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("15", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.DELTOID_MUSCLES, "Жим гантелей стоя",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday7.gif", "", 2, 5, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("16", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.DELTOID_MUSCLES, "Развод гантелей в стороны в наклоне",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Tuesday/tuesday8.gif", "", 3, 4, 65, 0, 2));

        _exercisesGrossMotor.add(new Exercise("17", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PRESS, "Скручивания",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday1.gif", "", 2, 8, 5, 0, 2));

        _exercisesGrossMotor.add(new Exercise("18", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PRESS, "Подъёмы ног",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday2.gif", "", 2, 5, 6, 0, 2));

        _exercisesGrossMotor.add(new Exercise("19", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PRESS, "Ножницы",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday3.gif", "", 2, 6, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("20", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.PRESS, "Пресс на мяче",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday4.gif", "", 2, 6, 6, 0, 2));
        _exercisesGrossMotor.add(new Exercise("21", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.UPPER_BACK_MUSCLES, "Подтягивания",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday5.gif", "", 2, 3, 8, 0, 3));

        _exercisesGrossMotor.add(new Exercise("22", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.UPPER_BACK_MUSCLES, "Подтягивания на низкой перекладине",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday6.gif", "", 3, 4, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("23", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.UPPER_BACK_MUSCLES, "Тяга штанги к груди в наклоне",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday7.gif", "", 2, 4, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("24", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.UPPER_BACK_MUSCLES, "Упражнение с резинкой",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Wednesday/wednesday8.gif", "", 3, 8, 3, 0, 2));

        _exercisesGrossMotor.add(new Exercise("25", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.QUADRICEPS, "Приседания с грифом",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday1.gif", "", 2, 5, 6, 0, 2));

        _exercisesGrossMotor.add(new Exercise("26", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.QUADRICEPS, "Выпады с гантелями в руках",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday2.gif", "", 3, 5, 6, 0, 2));

        _exercisesGrossMotor.add(new Exercise("27", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.QUADRICEPS, "Выпады с лавки",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday3.gif", "", 3, 3, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("28", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.QUADRICEPS, "Разгибание ног с грузом",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday4.gif", "", 2, 6, 5, 0, 2));

        _exercisesGrossMotor.add(new Exercise("29", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.LOWER_BACK_MUSCLES, "Гиперэкстензия",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday5.gif", "", 3, 4, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("30", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.LOWER_BACK_MUSCLES, "Обратная гиперэкстензия",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday6.gif", "", 3, 4, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("31", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.LOWER_BACK_MUSCLES, "Подъёмы рук и ног из положения лёжа на животе",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday7.gif", "", 2, 4, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("32", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.LOWER_BACK_MUSCLES, "Становая тяга штанги",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Thursday/thursday8.gif", "", 2, 7, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("33", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Бег",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday1.png", "минут", 1, 10, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("34", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Приседания",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday2.png", "", 3, 6, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("35", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Отжимания",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday3.png", "", 2, 4, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("36", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Планка",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday4.png", "секунд", 1, 30, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("37", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Ходьба на руках",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday5.png", "секунд", 2, 15, 8, 0, 2));

        _exercisesGrossMotor.add(new Exercise("38", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Прогулка фермера",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday6.png", "секунд", 2, 30, 5, 0, 2));

        _exercisesGrossMotor.add(new Exercise("39", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Ставим-снимаем (упражнение с грузом)",
                "1. Положи груз на пол.\n\n" +
                        "2. Поднимай его вверх, а затем снова ставь на пол.\n\n",
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday7.png", "", 3, 5, 7, 0, 2));

        _exercisesGrossMotor.add(new Exercise("40", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Тяни-толкай",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday8.png", "", 2, 6, 6, 0, 2));

        _exercisesGrossMotor.add(new Exercise("41", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Тяга груза за верёвку сидя",
                ...
                "gs://trainaut-database.appspot.com/GrossMotor/Friday/friday9.png", "", 2, 6, 7, 0, 2));

        _exercisesFineMotor.add(new Exercise("42", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.HAND_CONTROL, "Сортировка мелких предметов",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Monday/monday1.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("43", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.HAND_CONTROL, "Работа с прищепками",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Monday/monday2.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("44", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.HAND_CONTROL, "Игра с пуговицами",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Monday/monday3.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("45", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.FINGER_STRENGTH, "Игры с пластилином или тестом",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Tuesday/tuesday1.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("46", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.FINGER_STRENGTH, "Пересыпание крупы",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Tuesday/tuesday2.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("47", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.FINGER_STRENGTH, "Перекладывание с пинцетом",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Tuesday/tuesday3.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("48", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.COORDINATION, "Мозаика или пазлы",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Wednesday/wednesday1.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("49", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.COORDINATION, "Нанизывание бусин или макарон",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Wednesday/wednesday2.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("50", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.COORDINATION, "Перекладывание мелких предметов ложкой",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Wednesday/wednesday3.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("51", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.SENSORY_PERCEPTION, "Игры с сенсорными мячиками",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Thursday/thursday1.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("52", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.SENSORY_PERCEPTION, "Игры с кинетическим песком или песочной массой",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Thursday/thursday2.jpg", "", 0, 0, 100, 0, 0));

        _exercisesFineMotor.add(new Exercise("53", MotorSkillGroup.FINE_MOTOR, FineMotorMuscleGroup.SENSORY_PERCEPTION, "Рисование пальцами или кисточками",
                ...
                "gs://trainaut-database.appspot.com/FineMotor/Thursday/thursday3.jpg", "", 0, 0, 100, 0, 0));
        ...
        getAllExercises(existingExercises -> {
            ...
            for (Exercise exercise : _exercisesGrossMotor) {
                if (!existingNames.contains(exercise.getName())) {
                    _exerciseRepository.add(exercise, onSuccess, onFailure);
                } else {
    ...
    public void initializeDayPlans(OnSuccessListener<Void> onSuccess, OnFailureListener onFailure) {
        ...
        for (Exercise exerciseGross : _exercisesGrossMotor) {
        ...
        for (Exercise exerciseFine : _exercisesFineMotor) {
        ...
        getAllDayPlans(existingDayPlans -> {
            ...
            for (DayPlan dayPlan : dayPlans) {
                if (!existingDays.contains(dayPlan.getWeekDay().name())) {
                    _dayPlanRepository.addDayPlan(dayPlan, onSuccess, onFailure);
                } else {
    ...
    public void getAllDayPlans(OnSuccessListener<List<DayPlan>> onSuccess, OnFailureListener onFailure) {
        _dayPlanRepository.getAllDayPlans(onSuccess, onFailure);
    }

    private void getAllExercises(OnSuccessListener<List<Exercise>> onSuccess, OnFailureListener onFailure) {
        _exerciseRepository.getAll(onSuccess, onFailure);
    }
}
