...
//        this.trainingPlanRepository = trainingPlanRepository;
    ...
    public void initializeExercises(OnSuccessListener<Void> onSuccess, OnFailureListener onFailure) {
        ...
        exercisesGrossMotor.add(new Exercise("33", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Бег", "",
                ...
                "https://avatars.mds.yandex.net/i?id=a227635f676efb47e3752aa9d1c03715dde2e0a8-7664914-images-thumbs&n=13", "минут", false, 1, 10, 80, 0, 2));
        ...
        exercisesGrossMotor.add(new Exercise("36", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Планка", "",
                ...
                "https://avatars.mds.yandex.net/i?id=6c519f7f6a3c045bd8d997748e0d6cc881505b50-10330387-images-thumbs&n=13", "секунд", false, 1, 30, 85, 0, 2));
        ...
        exercisesGrossMotor.add(new Exercise("37", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Ходьба на руках", "",
                ...
                "https://fhd.multiurok.ru/f/c/4/fc42a6c84d76b0db314b3e747470f6bdeb1c9437/volieibol-obuchieniie-tiekhnikie-mietodikie-ighry_2.jpeg", "секунд", false, 2, 15, 80, 0, 2));
        ...
        exercisesGrossMotor.add(new Exercise("38", MotorSkillGroup.GROSS_MOTOR, GrossMotorMuscleGroup.FULL_BODY, "Прогулка фермера", "",
                ...
                "https://avatars.mds.yandex.net/i?id=6435cb5e96101774f3b391b70c96a40d633d951cc97a5647-12510741-images-thumbs&n=13", "секунд", false, 2, 30, 55, 0, 2));
...
//        List<Exercise> saturdayExercises = new ArrayList<>();
        ...
        dayPlans.add(new DayPlan("monday", WeekDay.MONDAY, mondayExercisesGrossMotor, mondayExercisesFineMotor, false));
        dayPlans.add(new DayPlan("tuesday", WeekDay.TUESDAY, tuesdayExercisesGrossMotor, tuesdayExercisesFineMotor, false));
        dayPlans.add(new DayPlan("wednesday", WeekDay.WEDNESDAY, wednesdayExercisesGrossMotor, wednesdayExercisesFineMotor, false));
        dayPlans.add(new DayPlan("thursday", WeekDay.THURSDAY, thursdayExercisesGrossMotor, thursdayExercisesFineMotor, false));
        dayPlans.add(new DayPlan("friday", WeekDay.FRIDAY, fridayExercisesGrossMotor, fridayExercisesFineMotor, false));
