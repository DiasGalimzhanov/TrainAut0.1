...
//                "https://cdn.culture.ru/images/593bd4d7-de4f-509d-9895-d506ad59ddb8", false, 3, 25, "секунд", 70, 0, 2));
    ...
    public void initializeDayPlans(OnSuccessListener<Void> onSuccess, OnFailureListener onFailure) {
        ...
        dayPlans.add(new DayPlan("monday", WeekDay.MONDAY, mondayExercisesGrossMotor, mondayExercisesFineMotor, 800));
        dayPlans.add(new DayPlan("tuesday", WeekDay.TUESDAY, tuesdayExercisesGrossMotor, tuesdayExercisesFineMotor, 800));
        dayPlans.add(new DayPlan("wednesday", WeekDay.WEDNESDAY, wednesdayExercisesGrossMotor, wednesdayExercisesFineMotor, 800));
        dayPlans.add(new DayPlan("thursday", WeekDay.THURSDAY, thursdayExercisesGrossMotor, thursdayExercisesFineMotor, 800));
        dayPlans.add(new DayPlan("friday", WeekDay.FRIDAY, fridayExercisesGrossMotor, fridayExercisesFineMotor, 800));
